...
mod tests_utils {
    ...
    use crate::tests::common::ffi_mock::{
        ffi_mocks_activity_usage::set_mock_activity_usage, ffi_mocks_energy_consumption::set_mock_energy_consumption,
        ffi_mocks_init::set_mock_init, ffi_mocks_memory_usage::set_mock_memory_usage,
